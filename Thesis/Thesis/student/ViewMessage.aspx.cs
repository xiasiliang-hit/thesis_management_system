...
/*
             if (uidStr != null)
             {
                 Guid guid = new Guid(uidStr);
                 sid = UserIdentifier.getIDByUID(guid);
...
/*    private string findAdminName()
    {
        ...
        cmd.Parameters.AddWithValue("@aid", aid = Request.QueryString["aid"]);
        try
        {
            conn.Open();
...
*/
    private void countNumber()
    {
        ...
        SqlCommand cmd = new SqlCommand(sql, conn);
        cmd.Parameters.AddWithValue("@mto", Request.QueryString["sid"]);
        cmd.Parameters.AddWithValue("@mfrom", Request.QueryString["sid"]);
        try
        {
            conn.Open();
    ...
    private void paginate()
    {
        ...
        string sql = "select * from message where mto = '"+Request.QueryString["sid"]+ "' or mfrom = '"+Request.QueryString["sid"] + "'order by mdatetime desc"; 
