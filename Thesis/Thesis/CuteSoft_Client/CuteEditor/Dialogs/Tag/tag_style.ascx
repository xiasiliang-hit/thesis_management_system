...
<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1002&file=Dialog_Tag_Style.js"></script>
...
var OxO5be6=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO5be6[1],true)[OxO5be6[0]]=function (){if(event[OxO5be6[2]]){alert(element[OxO5be6[3]].cssText);} ;} ;
</script>
