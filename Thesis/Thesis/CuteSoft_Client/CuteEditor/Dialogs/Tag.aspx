...
rel=stylesheet type=text/css href="Load.ashx?type=style&amp;file=IE.css"><![endif]-->
			...
			var OxO27e3=["nocancel"];top[OxO27e3[0]]=true;
			</script>
			<%}else{%>
			<script type="text/javascript">
			var OxO7d68=["nocancel"];top[OxO7d68[0]]=false;
			</script>
			<%}%>
			<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1002&amp;file=Dialog_TagHead.js"></script>
	</head>
	<body>
		<div id="container">
		...
		<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1002&amp;file=Dialog_TagFoot.js"></script>
	</body>
</HTML>
