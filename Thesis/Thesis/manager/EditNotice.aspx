<%@ Page Language="C#" MasterPageFile="~/MMasterPage.master" AutoEventWireup="true" CodeFile="EditNotice.aspx.cs" Inherits="manager_EditNotice" Title="&#26080;&#26631;&#39064;&#39029;" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <td>
        <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Names="&#40657;&#20307;" 
            ...
            <td>
        <asp:TextBox ID="txtTitle" runat="server" Width="547px" MaxLength="30"></asp:TextBox>
        </td>
    </tr>
    <tr>
    <td class="style3">
    ...
    <ce:editor id="editorNotice" runat="server" ThemeType="Office2007" Width="100%" 
            Height="200px" AutoConfigure="Simple"/>
         <center>   
