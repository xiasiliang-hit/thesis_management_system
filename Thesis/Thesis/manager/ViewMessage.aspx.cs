...
public partial class manager_ViewMessage : System.Web.UI.Page
{
    ...
    private void countNumber()
    {
        ...
        SqlCommand cmd = new SqlCommand(sql, conn);
        cmd.Parameters.AddWithValue("@mto", Request.QueryString["aid"]);
        cmd.Parameters.AddWithValue("@mfrom", Request.QueryString["aid"]);
        try
        {
            conn.Open();
    ...
    private void paginate()
    {
        ...
        string sql = "select * from message where mto = '"+Request.QueryString["aid"]+ "' or mfrom = '"+Request.QueryString["aid"] + "'order by mid desc"; 
