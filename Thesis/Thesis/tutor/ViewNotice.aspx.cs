...
public partial class tutor_ViewNotice : System.Web.UI.Page
{
    ...
    private void countNumber()
    {
        ...
        string sql = "select count(*) from notice where ntarget = 1 or ntarget = 2";
    ...
    {
        SqlConnection conn = new SqlConnection(db.connDB());
        string sql = "select * from notice where ntarget = 1 or ntarget = 2 order by nid desc";
