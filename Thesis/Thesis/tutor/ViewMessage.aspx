<%@ Page Language="C#" MasterPageFile="~/TMasterPage.master" AutoEventWireup="true" CodeFile="ViewMessage.aspx.cs" Inherits="manager_ViewMessage" Title="查看留言" %>
 ...
 <table border="1" width="100%"> 
        <asp:Repeater ID="rpMessage" runat="server">
            <HeaderTemplate>
                    <tr>
            <th colspan="5">
                <a href="AddMessage.aspx?uid=<%# uidStr %>&tid=<%# tid %>">&#26032;&#30041;&#35328;</a>
            </th>
        </tr>
                    <tr>
                        <th width="50%">&#26631;&#39064;</th>
            ...
            <ItemTemplate>
                <tr>
                    <td><a href="ViewDetailMessage.aspx?uid=<%# uidStr %>&tid=<%# tid %>mid=<%#Eval("mid") %> %>"><%#DataBinder.Eval(Container.DataItem, "mtitle")%></a></td>
